...
import org.health.Configuration;
import org.health.Main;
import org.health.api.BarHideEvent;
import org.health.utils.PlayerBarUtils;
import org.health.utils.Utils;
...
public class PlayerBar {
    ...
    public static void setupBelow() {
        ...
        if (playerEnabled && useBelow) {
            ...
            belowObj.setDisplayName(Utils.replaceSymbols(instance.getConfig()
                                                                 .getString(
                                                                 Configuration.Nodes.PLAYERS_BELOW_TEXT.getNode())));
    ...
    public static void updateHealthBelow(final Player player) {
        if (useBelow && playerEnabled) {
            ...
            if (belowUseRawAmountOfHearts) {
                ...
                score = Utils.roundUpPositive((player.getHealth()) * ((double) belowNameProportion)
                                              / (player.getMaxHealth()));
            } else {
