    ...
    public void onPlayerDeathEvent(PlayerDeathEvent event) {
        ...
        try {
            ...
            if (damageEvent instanceof EntityDamageByEntityEvent) {
                ...
                // ----------------------NORMAL KILL-------------------------
                if (deathMessage.contains("killed")
                        || deathMessage.contains("slain")
                        || deathMessage.contains("got finished")) {
                    if (damager instanceof Player) {
                        ...
                        if (itemname == null) {
                            ...
                            event.setDeathMessage(victim + " was slain by " + ((Player) damager).getName() + " using "
                                                  + itemname);
            ...
            if (deathMessage.contains("high place")
                    || deathMessage.contains("doomed to fall")
                    || deathMessage.contains("fell off")
                    || deathMessage.contains("fell out of the water")) {
